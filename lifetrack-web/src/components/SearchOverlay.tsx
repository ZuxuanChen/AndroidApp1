    ...
    <div className="fixed inset-0 bg-black/40 z-[60] flex items-start justify-center pt-[15vh]" onClick={onClose}>
      ...
      >
        ...
        <div className="flex items-center gap-3 px-4 py-3 border-b border-gray-100">
          ...
          <kbd className="hidden sm:inline-block px-2 py-0.5 bg-gray-100 rounded text-xs text-gray-500">ESC</kbd>
        </div>
        ...
        <div className="max-h-[50vh] overflow-y-auto">
          ...
          {results.length === 0 && !query.trim() && (
            <div className="px-4 py-6 text-sm text-gray-400 space-y-1">
              <p className="font-medium text-gray-500 mb-2">搜索提示</p>
